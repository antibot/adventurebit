...
function ppl_set_options($option_key, $arg, $default_output_template) {
	...
	if (isset($arg['custom-key'])) {$arg['custom']['key'] = stripslashes($arg['custom-key']); unset($arg['custom-key']);}
	if (isset($arg['custom-op'])) {$arg['custom']['op'] = $arg['custom-op']; unset($arg['custom-op']);}
	if (isset($arg['custom-value'])) {$arg['custom']['value'] = stripslashes($arg['custom-value']); unset($arg['custom-value']);}
	if (isset($arg['contains-key'])) {$arg['contains']['key'] = stripslashes($arg['contains-key']); unset($arg['contains-key']);}
	if (isset($arg['contains-op'])) {$arg['contains']['op'] = $arg['contains-op']; unset($arg['contains-op']);}
	if (isset($arg['contains-value'])) {$arg['contains']['value'] = stripslashes($arg['contains-value']); unset($arg['contains-value']);}
	...
	if (!isset($arg['contains'])) $arg['contains'] = $options['contains'];
	...
	$arg['handle_cache'] = $options['handle_cache'];
...
function where_check_contains($key, $op, $value) {
	if ($op === 'includes') {
		return "$key LIKE '%$value%'";
	} else if ($op === 'omits'){
		return "NOT $key LIKE '%$value%'";
	} else if ($op === 'regexp'){	

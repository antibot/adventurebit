...
function ppl_options_from_post($options, $args) {
	foreach ($args as $arg) {
		...
		case 'custom':
			...
			break;
		case 'contains':
			$options['contains']['key'] = $_POST['contains-key'];
			$options['contains']['op'] = $_POST['contains-op'];
			$options['contains']['value'] = $_POST['contains-value'];
			break;
		case 'sort':
...
function ppl_display_custom($custom) {
	...
	<tr valign="top">
		...
		<td>
			...
			<tr>
			<td style="border-bottom-width: 0"><input name="custom-key" type="text" id="custom-key" value="<?php echo stripslashes($custom['key']); ?>" size="20" /></td>
			<td style="border-bottom-width: 0">
			...
			<td style="border-bottom-width: 0"><input name="custom-value" type="text" id="custom-value" value="<?php echo stripslashes($custom['value']); ?>" size="20" /></td>
			</tr>
			</table>
		</td>
	</tr>
...
function ppl_display_contains($contains) {
	?>
	<tr valign="top">
		<th scope="row"><?php _e('Match posts where:', 'post_plugin_library') ?></th>
		<td>
			<table>
			<tr><td style="border-bottom-width: 0">Field Name</td><td style="border-bottom-width: 0"></td><td style="border-bottom-width: 0">Field Value</td></tr>
			<tr>
			<td style="border-bottom-width: 0">				
				<select name="contains-key" id="contains-key">
				<option <?php if($contains['key'] == 'post_content') { echo 'selected="selected"'; } ?> value="post_content">Content</option>
				<option <?php if($contains['key'] == 'post_title') { echo 'selected="selected"'; } ?> value="post_title">Title</option>
				</select>
			</td>
			<td style="border-bottom-width: 0">
				<select name="contains-op" id="contains-op">
				<option <?php if($contains['op'] == 'includes') { echo 'selected="selected"'; } ?> value="includes">includes</option>
				<option <?php if($contains['op'] == 'omits') { echo 'selected="selected"'; } ?> value="omits">doesn't include</option>
				<option <?php if($contains['op'] == 'regexp') { echo 'selected="selected"'; } ?> value="regexp">MySQL Reg Ex</option>
				</select>
			</td>
			<td style="border-bottom-width: 0"><input name="contains-value" type="text" id="contains-value" value="<?php echo stripslashes($contains['value']); ?>" size="20" /></td>
			</tr>
			</table>
		</td>
	</tr>
